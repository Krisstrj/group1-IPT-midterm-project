...
<footer id="footer" class="footer">
    <div class="container">
        <div class="footer-content">
            <div class="footer-section about">
                ...
                <p>
                    Your one-stop solution for managing books, tracking inventory, and organizing library resources efficiently.
                </p>
    ...
    <div class="copyright">
        &copy; Copyright <strong><span>Book Management System</span></strong>. All Rights Reserved
    </div>
